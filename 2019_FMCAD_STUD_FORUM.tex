...
\label{sec:pre}
Preprocessing techniques can be extremely beneficial. The basic idea is to try to reduce the input formula by simplification procedures.
%
Which (in principle) substantially decrease the run time of solvers.
%Assumption: smaller problems are easier to solve
Inprocessing XXX. 
%
In practice it might pay off to spend
more time on pre/inprocessing due to the hardness of DQBF.
