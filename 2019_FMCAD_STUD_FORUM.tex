...
%and present more complex autarky systems, 
namely $A_2$ and $E_2$. 
%
...
which doesn't allow any further autarky. This unique final result of autarky reduction is \textbf{lean kernel} of the original formula.
\subsection{Symmetry}
\label{sec:sym}
