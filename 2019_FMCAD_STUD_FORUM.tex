...
%
Making it suitable to model problems known to be NEXPTIME-complete, e.g. partial information non-cooperative games, program synthesis, probabilistic planning of finite length, and certain bit-vector logics.
